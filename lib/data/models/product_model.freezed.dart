...
class _ProductModel implements ProductModel {
  const _ProductModel({required this.id, required this.title, this.description = '', required this.price, this.discountPercentage = 0.0, this.rating = 0.0, this.stock = 0, this.brand = '', this.category = '', this.thumbnail = '', final  List<String> images = const []}): _images = images;
